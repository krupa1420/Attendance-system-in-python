...
logo = Image.open("Images/Bvm Logo.png")
...
titl = tk.Label(
    window, text="Birla Vishvakarma Mahavidyalaya!!", bg="black", fg="green", font=("arial", 27),
)
...
ri = Image.open("Images/register.png")
r = ImageTk.PhotoImage(ri)
label1 = Label(window, image=r)
label1.image = r
label1.place(x=100, y=270)

vi = Image.open("Images/view.png")
v = ImageTk.PhotoImage(vi)
label3 = Label(window, image=v)
label3.image = v
label3.place(x=500, y=270)

ai = Image.open("Images/mark.png")
...
def automatic_attedance():
    takeattendance.subjectChoose(text_to_speech)
...
def view_attendance():
    viewattendance.subjectchoose(text_to_speech)
